...
public class SlideshowFavoritedResponseHandler extends AbstractResponseHandler {

    private final SlideShowFavorited slideShowFavorited = new SlideShowFavorited();
    ...
    public SlideShowFavorited getSlideShowFavorited() {
        return slideShowFavorited;
    }
    ...
    public void handleEndOf(String uri, String localName, String qName)
        ...
        if (localName.equals(SlideshowCheckFavoriteResponseHandler.TAG_SLIDESHOW_ID)) {
            slideShowFavorited.setSlideShowID(value.trim());
        }
        value = "";
    }
    ...
    public Object getResult() {
        return this.getSlideShowFavorited();
    }
